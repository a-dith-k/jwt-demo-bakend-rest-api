...
public class AdminController {
    ...
    @PostMapping("/users")
    public ResponseEntity<Void> createUser(@Valid @RequestBody UserRequestDto request) throws UserAlreadyExistsException {
    ...
    @PutMapping("/users/{id}")
    public ResponseEntity<Void> updateUser(@PathVariable Integer id,@RequestBody UserRequestDto request) throws UserNotFoundException, UserAlreadyExistsException {
